...
1 Le passeport ordinaire et le passeport provisoire sont émis sous forme de livret ISO/IEC 7810; format ID-3; OACI 9303.

2 La carte d’identité est émise au format d’une carte de crédit ISO/IEC 7810; format ID-1; OACI 9303.
...
2 La photographie doit comporter les caractéristiques suivantes: image en niveaux de gris (8 bits par pixel) en format JPEG ISO/IEC IS 10918-1, avec une compression de haute qualité (taille du fichier: env. 700 kB) de format baseline (standard). Elle ne peut pas être retouchée.
...
**Art. 16** Art. 16 Numéro du document d’identité
...
**Art. 28** Art. 28 Etablissement de documents d’identité en cas de mariage
