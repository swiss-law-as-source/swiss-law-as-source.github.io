...
1. Lo scopo del Gruppo è, nell’interesse collettivo dei suoi membri, di promuovere la responsabilità ufficiale o l’attività principale dei membri e di organizzare la cooperazione fra i membri che lavorano in rete, per aiutarli a fornire:a) conoscenze specialistiche di prim’ordine nei settori della meteorologia, del clima e dell’ambiente e nelle attività correlate;b) un supporto tecnico alla comunità scientifica corrispondente;c) dati di base e prodotti di elevata qualità;d) una comunicazione efficace con l’UE su questioni riguardanti la collettività dei membri.
