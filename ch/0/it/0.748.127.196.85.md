...
5. Se tra le Parti esiste una Convenzione speciale per evitare la doppia imposizione in materia di imposte sul reddito e sul patrimonio, le disposizioni di tale Convenzione prevalgono.
...
4. Le imprese designate dell’una o dell’altra Parte possono concludere con imprese designate di ciascuna Parte o con imprese di trasporti aerei di uno Stato terzo, purché queste dispongano della corrispondente autorizzazione d’esercizio, accordi di cooperazione come accordi di prenotazione di capacità («blocked space»), accordi di ripartizione di codici («code sharing») o altri accordi commerciali.
...
**Art. 15** Art. 15 Servizi intermodali
...
3. I suddetti servizi di trasporto intermodale di merci possono essere offerti, in conformità alla legislazione di ogni Stato, ad un prezzo unico, comprensivo di tutto il trasporto combinato aria-superficie.
...
Fatto a Kuala Lumpur il 24 ottobre 2024, in doppio esemplare, nelle lingue inglese e francese, i due testi facenti parimenti fede. In caso di divergenze di attuazione, interpretazione o applicazione, prevale il testo inglese.

Per il Consiglio federale svizzero:

Marcel Kägi

Per il Governo della Repubblica di Sierra Leone:
